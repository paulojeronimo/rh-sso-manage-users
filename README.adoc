...
:create-users-sh: {uri-raw}/create-user.sh[create-users.sh^]
...
possível <<passo4,adicionar uma massa de usuários>>, <<passo5,obter
tokens válidos para cada usuário>> e, por fim, <<passo6,remover esses
usuários>> quando eles não forem mais necessários.
